<div class="d-flex">
    <aside class="sidebar d-flex flex-column p-3 gap-2">
        ...
        <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 <?= str_contains($_SERVER['REQUEST_URI'], '/funcionarios') ? 'active' : '' ?>"
                   href="<?= BASE_URL . '/funcionarios' ?>">
        ...
        <div class="d-flex flex-column gap-2 px-1">
            ...
            <a href="<?= BASE_URL . '/funcionarios/novo' ?>" class="btn btn-amber btn-sm d-flex align-items-center gap-2">
